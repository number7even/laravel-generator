...
namespace Number7even\Generator\Utils;

use DB;
use Number7even\Generator\Common\GeneratorField;
use Number7even\Generator\Common\GeneratorFieldRelation;
...
class TableFieldsGenerator
{
    ...
    public function __construct($tableName)
    {
        ...
        $this->defaultSearchable = config('Number7even.laravel_generator.options.tables_searchable_default', false);
    }
    ...
    {
        if (!config('Number7even.laravel_generator.timestamps.enabled', true)) {
            return [];
        }

        $createdAtName = config('Number7even.laravel_generator.timestamps.created_at', 'created_at');
        $updatedAtName = config('Number7even.laravel_generator.timestamps.updated_at', 'updated_at');
        $deletedAtName = config('Number7even.laravel_generator.timestamps.deleted_at', 'deleted_at');
