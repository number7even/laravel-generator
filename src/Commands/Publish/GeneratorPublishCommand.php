...
class GeneratorPublishCommand extends PublishBaseCommand
{
     ...
     * @var string
     */
    protected $name = 'Number7even:publish';
    ...
    {
        $apiVersion = config('Number7even.laravel_generator.api_version', 'v1');
        $apiPrefix = config('Number7even.laravel_generator.api_prefix', 'api');
    ...
    private function publishTestCases()
    {
        ...
        $testsPath = config('Number7even.laravel_generator.path.api_test', base_path('tests/'));
