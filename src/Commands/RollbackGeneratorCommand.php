...
namespace Number7even\Generator\Commands;

use Illuminate\Console\Command;
use Number7even\Generator\Common\CommandData;
use Number7even\Generator\Generators\API\APIControllerGenerator;
use Number7even\Generator\Generators\API\APIRequestGenerator;
use Number7even\Generator\Generators\API\APIRoutesGenerator;
...
use Number7even\Generator\Generators\Scaffold\ControllerGenerator;
use Number7even\Generator\Generators\Scaffold\MenuGenerator;
use Number7even\Generator\Generators\Scaffold\RequestGenerator;
use Number7even\Generator\Generators\Scaffold\RoutesGenerator;
use Number7even\Generator\Generators\Scaffold\ViewGenerator;
use Number7even\Generator\Generators\TestTraitGenerator;
use Number7even\Generator\Generators\VueJs\ControllerGenerator as VueJsControllerGenerator;
use Number7even\Generator\Generators\VueJs\ModelJsConfigGenerator;
use Number7even\Generator\Generators\VueJs\RoutesGenerator as VueJsRoutesGenerator;
use Number7even\Generator\Generators\VueJs\ViewGenerator as VueJsViewGenerator;
...
class RollbackGeneratorCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'Number7even:rollback';
    /**
