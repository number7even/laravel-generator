...
namespace Number7even\Generator\Generators;

use Number7even\Generator\Common\CommandData;
use Number7even\Generator\Utils\FileUtil;
use Number7even\Generator\Utils\TableFieldsGenerator;
...
class ModelGenerator extends BaseGenerator
{
     ...
     *
     * @param \Number7even\Generator\Common\CommandData $commandData
     */
    public function __construct(CommandData $commandData)
    {
        $this->commandData = $commandData;
        $this->path = $commandData->config->pathModel;
        $this->fileName = $this->commandData->modelNameStudlyCase.'.php';
    ...
    private function fillSoftDeletes($templateData)
    {
        if (!$this->commandData->getOption('softDelete')) {
            ...
            $deletedAtTimestamp = config('Number7even.laravel_generator.timestamps.deleted_at', 'deleted_at');
            $templateData = str_replace(
